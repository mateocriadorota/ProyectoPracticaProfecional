...
$consultaTiposVehiculo = $bd->query(
    "SELECT * from tipo_vehiculo where activo=1"
);
...
$consultatabla = $bd->query("SELECT r.id_cochera, r.hora_entrada, v.patente, t.nombre,f.horario_salida
    FROM reserva r, tipo_vehiculo t, vehiculo v  , factura f
    WHERE r.patente = v.patente
    AND v.id_tipovehiculo = t.id_tipovehiculo
    AND f.cod_reserva=r.codigo_reserva
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-around mb-4">
                            <a href="salidavehiculo.php" class="d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Salida de Vehiculos</a>
                            <a href="entradavehiculo.php" class="d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Entrada de Vehiculos</a>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            <?php foreach ($consultaTiposVehiculo as $vehiculo) { ?>
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo isset(
                                                            $diccionarioVehiculos[$vehiculo["id_tipovehiculo"]]
                                                        )
                                                            ? count($diccionarioVehiculos[$vehiculo["id_tipovehiculo"]])
                                                            : 0; ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Ultimos egresos:</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                    <table class="table">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow mb-4 h-100">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Ultimos ingresos:</h6>
                                    </div>
                                    <div class="card-body">
                                    <table class="table">
                                                                    <thead>
