...
//Guardando el id de la cochera por la url

$id = $_GET['id'];
//Seleccionando empleado en la base de datos

$query = "SELECT * FROM empleado WHERE cod_empleado='$id'";
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">EDITAR USUARIO</h1>
                                    ...
                                    <!-- Cargando datos del usuario actuales para editarlos -->
                                    <form class="user" action="../actualizardatosusuario.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control form-control-user" name="id" 
                                                value="<?php echo $filas['cod_empleado']?>" id="cochera_hidden">
                                        </div>
                                        <div class="form-group">
                                            <label for="ubicacion">Usuario</label>
                                            <input type="text" class="form-control form-control-user" name="usuario" 
                                                placeholder="Ubicación" value="<?php echo $filas['username']?>" id="usuario">
                                        </div>

                                        <div class="form-group">
                                            <label for="ubicacion">Nombre</label>
                                            <input type="text" class="form-control form-control-user" name="nombre" 
                                                placeholder="Ubicación" value="<?php echo $filas['nombre']?>" id="nombre">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="tamanio">Apellido</label>
                                            <input type="text" class="form-control form-control-user" name="apellido" 
                                                placeholder="Tamaño máximo" style="width: 100%;" value="<?php echo $filas['apellido']?>" id="apellido" />
                                        </div>
                                        <div class="form-group">
                                            <label for="tamanio">Password</label>
                                            <input type="password" class="form-control form-control-user" name="pass" 
                                                placeholder="Ingrese Password" style="width: 100%;" value="<?php echo $filas['password']?>" />
                                        </div>
