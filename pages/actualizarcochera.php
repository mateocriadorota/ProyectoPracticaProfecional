...
$query = "SELECT * FROM cochera WHERE id_cochera='$id'";
                    ...
                    <div class="col-lg-8">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">EDITAR COCHERA</h1>
                            </div>
                                    <!-- Cargando datos de la cochera actuales para editarlos -->
                                    <form class="user" action="../actualizardatoscochera.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control form-control-user" name="id" 
                                                value="<?php echo $filas['id_cochera']?>" id="cochera_hidden">
                                        </div>
                                        <div class="form-group">
                                            <label for="ubicacion">Ubicación</label>
                                            <input type="text" class="form-control form-control-user" name="ubicacion" 
                                                placeholder="Ubicación" value="<?php echo $filas['id_cochera']?>" id="ubicacion">
                                        </div>
                                        <div class="form-group">
                                            <label for="tamanio">Tamaño máximo</label>
                                            <input type="text" class="form-control form-control-user" name="tamanio" 
                                                placeholder="Tamaño máximo" style="width: 100%;" value="<?php echo $filas['tamaniomax']?>" id="tamanio" />
                                        </div>
